...
class GameManager:
    ...
    def update_damage(cls):
        cls.player_uis[0].take_damage(cls.mouseuser_damage_amount + player1_multiply)
    ...
    def round_end(cls, idx):
        ...
        if idx == 1:
            ...
            if cls.player1_win_count >= cls.max_round_end_count:
                ...
                print("마우스 승리")
                cls.player_uis[0].boardcast(True)
        else:
            ...
            if cls.player2_win_count >= cls.max_round_end_count:
                ...
                print("키보드 승리")
                cls.player_uis[1].boardcast(True)
    ...
    def game_end(cls, idx):
        if idx == 1:
            print("마우스 승리 !!")
            cls.player_uis[0].boardcast(True, True)
        else:
            print("키보드 승리 !!")
            cls.player_uis[1].boardcast(True, True)
    ...
    def reset_round(cls):
        ...
        cls.player_uis[0].value = 1
        cls.player_uis[0].calculate_healthbar()
        cls.player_uis[1].value = 1
        cls.player_uis[1].calculate_healthbar()
